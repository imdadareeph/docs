...
**Spring Data R2dbc 1.2 brought plenty of changes and broken APIs. For the newest Spring Boot 2.4 and Spring Data R2dbc 1.2, please go to [Spring R2dbc Sample](https://github.com/imdadareeph/reactive-spring) and update yourself to the latest R2dbc**.
...
The complete codes can be found in my [Github](https://github.com/imdadareeph/reactive-spring).

* [docker-compose.yaml](https://github.com/imdadareeph/reactive-spring/blob/master/docker-compose.yml) serves MySQL, MS SQL, PostgreSQL servers.
* [data-r2dbc](https://github.com/imdadareeph/reactive-spring/tree/master/data-r2dbc) A none Spring Boot sample using H2
* [data-r2dbc-postgresql](https://github.com/imdadareeph/reactive-spring/tree/master/data-r2dbc-postgresql) A none Spring Boot sample using PostgreSQL
* [boot-r2dbc](https://github.com/imdadareeph/reactive-spring/tree/master/boot-r2dbc) A Spring Boot based sample using H2 and `DatabaseClient`.
* [boot-data-r2dbc](https://github.com/imdadareeph/reactive-spring/tree/master/boot-data-r2dbc) A Spring Boot based sample using H2 and `Repository` interface.
* [boot-data-r2dbc-mysql](https://github.com/imdadareeph/reactive-spring/tree/master/boot-data-r2dbc-mysql) A Spring Boot based sample using MySQL and `Repository` interface.
* [boot-data-r2dbc-mssql](https://github.com/imdadareeph/reactive-spring/tree/master/boot-data-r2dbc-mssql) A Spring Boot based sample using MSSQL and `Repository` interface.
* [boot-data-r2dbc-postgresql](https://github.com/imdadareeph/reactive-spring/tree/master/boot-data-r2dbc-postgresql) A Spring Boot based sample using  PostgresSQL and `Repository` interface.